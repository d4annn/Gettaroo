...
public class GuiConfig extends GuiConfigsBase {
    ...
    public GuiConfig()
    {
        super(10, 50, References.MOD_ID, null, "gettaroo.gui.title.configs");
    }
    ...
    public enum ConfigGuiTab{
        TOGGLES("gettaroo.gui.button.config_gui.toggles"),
        TOGGLE_HOTKEYS("gettaroo.gui.button.config_gui.toggle_hotkeys"),
        HOTKEYS("gettaroo.gui.button.config_gui.hotkeys"),
        LISTS("gettaroo.gui.button.config_gui.lists"),
        UTILS("gettaroo.gui.button.config_gui.utils"),
        CHEAT_TOGGLES("gettaroo.gui.button.config_gui.cheat_toggles"),
        CHEAT_HOTKEYS("gettaroo.gui.button.config_gui.cheat_hotkeys"),
        SERVER("gettaroo.gui.button.config_gui.server");
